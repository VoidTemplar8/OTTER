...
bool initGLFW() {
	...
	window = glfwCreateWindow(800, 800, "100746578", nullptr, nullptr);
...
int main() {
	...
	// Push another scope so most memory should be freed *before* we exit the app
	{
		...
		Texture2D::sptr reflection = Texture2D::LoadFromFile("images/sample_spec.png");
		...
		material0->Set("u_EnvironmentRotation", glm::mat3(
			glm::rotate(glm::mat4(1.0f), glm::radians(90.0f), glm::vec3(1, 0, 0))));
		material0->Set("s_Environment", environmentMap);
		material0->Set("s_Reflectivity", reflection);
